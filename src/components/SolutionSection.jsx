...
export const SolutionSection = () => {
  return (
    <section id="control" className="py-32 bg-background relative border-t border-foreground/10 overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-7xl relative z-10">
        ...
        >
          <div className="grid lg:grid-cols-2 gap-0">
             ...
             {/* Left: Value Prop */}
             <div className="p-10 md:p-16 border-b lg:border-b-0 lg:border-r border-foreground/20 flex flex-col justify-between">
               <div>
                  <h3 className="text-4xl font-bold text-foreground mb-4 uppercase tracking-tighter flex items-center gap-4">
                    OneTex
                  ...
                  <p className="text-muted text-xl font-light mb-12">El centro de comando para operaciones pesadas y exigentes.</p>
               </div>
               ...
               <div className="space-y-6 mb-16">
                 {[
                   ...
                   <div key={i} className="flex gap-6 group">
                      <div className="font-mono text-sm text-muted group-hover:text-foreground transition-colors">{item.num}</div>
                      <div>
                        <h4 className="text-foreground font-bold uppercase tracking-tight text-lg mb-1">{item.title}</h4>
             ...
             <div className="p-10 md:p-16 bg-surface flex items-center justify-center relative overflow-hidden">
                {/* Minimalist Data Grid Mockup */}
                <div className="w-full h-full border border-foreground/10 flex flex-col">
                  {/* Header */}
                  <div className="h-12 border-b border-foreground/10 flex items-center justify-between px-6 bg-foreground/5">
                    <div className="flex gap-2">
                      <div className="w-2 h-2 bg-foreground/20 rounded-full" />
                      <div className="w-2 h-2 bg-foreground/20 rounded-full" />
                    </div>
                    <div className="text-xs font-mono text-muted">ONETEX // DASHBOARD</div>
                  </div>
                  {/* Body wireframes */}
                  <div className="flex-1 p-6 flex flex-col gap-6">
                    <div className="flex gap-6 h-32">
                      <div className="flex-1 border border-foreground/5 bg-foreground/[0.02]" />
                      <div className="flex-1 border border-foreground/5 bg-foreground/[0.02]" />
                      <div className="flex-1 border border-foreground/5 bg-foreground/[0.02] hidden md:block" />
                    </div>
                    <div className="flex-1 border border-foreground/5 bg-foreground/[0.02] flex items-end p-6">
                       {/* Mock Chart lines */}
                       <div className="w-full h-1/2 border-t border-l border-foreground/10 relative">
