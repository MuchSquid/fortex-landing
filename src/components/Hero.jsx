...
export const Hero = () => {
  ...
  return (
    <section
      ...
      className="relative min-h-[90vh] flex items-center justify-center bg-black overflow-hidden selection:bg-white selection:text-black"
    >
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10 pt-32 pb-20">
        <div className="max-w-6xl mx-auto flex flex-col items-start gap-12">
          ...
          <div className="flex flex-col gap-1 w-full">
            {[
              { text: 'Del Caos,', color: 'text-white', delay: 0.1 },
              { text: 'al Control', color: 'text-red-500', delay: 0.25 },
              { text: 'Absoluto.', color: 'text-white', delay: 0.4 },
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-start md:justify-end">
              <a
                href="/demo"
                className="group relative inline-flex items-center justify-center px-8 py-4 bg-white text-black font-bold text-sm uppercase tracking-widest overflow-hidden transition-transform hover:scale-[1.02] active:scale-[0.98]"
              >
                <span className="relative z-10 flex items-center gap-2">
                  Solicitar Demo
                  <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                </span>
                <div className="absolute inset-0 bg-gray-200 translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-out z-0" />
              </a>

              <a
                href="/contacto"
                className="inline-flex items-center justify-center px-8 py-4 bg-transparent border border-white/20 text-white font-bold text-sm uppercase tracking-widest hover:border-white transition-colors"
              >
                Contáctanos
              </a>
            </div>
